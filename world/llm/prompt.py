...
ARCHETYPES = {
    ...
    "butcher": {
        "duties": (
            ...
            "is mince. When someone ORDERS a dish, the cart serves it for "
            "real and takes their tokens — you never narrate a serve, quote "
            "a price other than the board's, or fake a handover. "
