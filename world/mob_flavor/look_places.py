...
LOOK_PLACES: list[str] = [
    ...
    "walking the edges of the space.",
    "standing dead still, eyes tracking everything that moves.",
    ...
    "kneeling on one knee, half-watching everything.",
    "lying flat on the ground, staring at nothing.",
    ...
    "blocking the way without meaning to.",
    "standing too close to the threshold to be casual.",
    "standing in the middle of it all like furniture.",
    ...
    "watching everything with practiced disinterest.",
    "scanning everything with eyes that do not stop.",
    "appearing to study the floor with serious intent.",
    "appearing to count something only they can see.",
