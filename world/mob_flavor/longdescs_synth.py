...
LONGDESCS_SYNTH: dict[str, list[str]] = {
    ...
    "eyes": [
        ...
        "One iris sits a fraction paler than the other, replaced and not quite matched.",
    ...
    "arms": [
        ...
        "One forearm sits a half-shade off the other, replaced at some point.",
    ...
    "thighs": [
        ...
        "One thigh is very slightly firmer than the other, and has been serviced more.",
        ...
        "The thighs are matched exactly, with no favoured side worn heavier than the other.",
    ],
    "shins": [
        ...
        "The hair stops at exactly the same height on both shins.",
    ],
    "feet": [
