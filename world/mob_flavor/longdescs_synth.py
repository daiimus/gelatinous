...
LONGDESCS_SYNTH: dict[str, list[str]] = {
    "hair": [
        ...
        "{They tuck} it behind an ear, a gesture learned rather than acquired.",
    ...
    "head": [
        ...
        "{They tilt} {their} head to listen, at an angle that was chosen for {them}.",
    ...
    "neck": [
        ...
        "{They swallow} at intervals no anxious person would keep.",
    ...
    "chest": {
        ...
        "any": [
            ...
            "{They breathe} in time with whoever is speaking, without appearing to try.",
    ...
    "abdomen": [
        ...
        "{They rest} a hand against {their} stomach now and then, the way a person would.",
    ...
    "groin": {
        ...
        "any": [
            ...
            "{They move} through the hips with an easy, level roll.",
    ...
    "hands": [
        ...
        "{They fold} {their} hands in {their} lap, in a posture somebody taught {them}.",
    ...
    "thighs": [
        ...
        "{They stand} evenly on both legs, always, with no favoured side.",
    ],
    "shins": [
        ...
        "{They knock} one shin against something and do not react.",
