...
LONGDESCS_SYNTH: dict[str, list[str]] = {
    ...
    "head": [
        ...
        "A service port sits behind one ear, capped and flush with the skin.",
        "The crown is faintly and constantly warm.",
        "It has been this shape for a long time, and will be for longer.",
        "Nothing about it is dated except, if you follow models, the jaw.",
        "{They tilt} it to listen, at an angle that was chosen for {them}.",
    ...
    "face": [
        ...
        "Dirt does not cling here the way it clings to everyone else in the room.",
        "It has not aged a day since it was commissioned, whenever that was.",
        ...
        "Stubble, where there is any, stops at a length somebody chose.",
        "{They blink} when spoken to, which is courtesy rather than need.",
        "There is no shine at the nose or brow, at any hour of any shift.",
        "The design reads a few years out of fashion, if you follow such things.",
    ],
    "neck": [
        ...
        "The skin here has never chapped, in a colony where everyone's does.",
        "It stays exactly as warm as the rest of {them}, in any weather.",
        "No cold has ever raised anything on this skin.",
        "{They swallow} at intervals no anxious person would keep.",
        "The scent here is clean, manufactured, and very faint.",
        "Nothing has thickened or loosened with any passing year.",
    ],
    "chest": {
        "female": [
            ...
            "Nothing here has changed with any month, because nothing here has months.",
        ],
        "male": [
            ...
            "Nothing has thickened or slackened in however many years this has run.",
            "The hair across it grows to one length and stops, as though instructed.",
            "The muscle holds its definition without maintenance of any kind.",
        ],
        "any": [
            ...
            "The warmth of it is constant, and owes nothing to effort.",
        ],
    },
    "back": [
        ...
        "The skin has taken no sun and no weather, though the colony offers both.",
        "Nothing has settled or slumped, though the frame is not new.",
        "One shoulder blade moves a fraction less freely than the other.",
        "Dust slides off rather than sitting, the way it does on nothing else here.",
        "There is no ache in it at the end of a shift, and never has been.",
    ],
    "abdomen": [
        ...
        "The skin has never stretched, because nothing has ever asked it to.",
        "Nothing here softens at the end of a long day.",
        "Nothing has left a mark, though a life leaves its marks here first.",
        "{They rest} a hand against it now and then, the way a person would.",
        "The warmth of it does not rise or fall with the room.",
    ],
    "groin": {
        "female": [
            ...
            "The curve here was drawn before it was ever grown.",
            "Nothing has softened or shifted with any passing year.",
        ],
        "male": [
            ...
            "Nothing here has thickened with age, because none of it ages.",
        ],
        "any": [
            ...
            "The skin is as unmarked here as everywhere else, which is the strangest part.",
            "{They move} through the hips with an easy, level roll.",
            "Everything reads fully human; only the deciding was different.",
        ],
    },
    "eyes": [
    ...
    "hands": [
        ...
        "There is no callus anywhere, on a colony that gives everybody callus.",
        "{They fold} them in {their} lap, in a posture somebody taught {them}.",
    ...
    "thighs": [
        ...
        "Nothing dimples where the weight rests, however long {they sit}.",
        "The skin is the same temperature at the knee as at the hip.",
        "One is very slightly firmer than the other, and has been serviced more.",
        "No hair grows in patchily, and none has been missed.",
        "Nothing has chafed here, in a body that walks as much as anyone's.",
        "{They stand} evenly on both, always, with no favoured side.",
    ],
    "shins": [
        ...
        "{They knock} one against something and do not react.",
        "A patch below one knee sits a shade off, a repair left as it was.",
        "The hair stops at exactly the same height on both.",
    ],
    "feet": [
