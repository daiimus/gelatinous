...
MESSAGES = {
    ...
    "laceration": {
        "grievous": [
            {
                "attacker_msg": "The torn blow rips {target_name}'s {hit_location} away in a small spray of {blood}.",
                "victim_msg": "{attacker_name}'s torn blow rips your {hit_location} away in a small spray of {blood}.",
                "observer_msg": "{attacker_name}'s torn blow rips {target_name}'s {hit_location} away in a small spray of {blood}.",
            },
        ],
        "minor": [
            {
